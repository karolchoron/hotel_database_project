...
/* Created on:     25.01.2021 19:13:57                          */
/*==============================================================*/
...
if exists(select 1 from sys.sysforeignkey where role='FK_Rezerwacja_Platnosc') then
    alter table Rezerwacja
       delete foreign key FK_Rezerwacja_Platnosc
end if;
...
drop index if exists DyzurPracyPracownika.Association_4_PK;
...
drop index if exists Platnosc.Platnosc_PK;
...
drop index if exists Rezerwacja.Rezerwacja_Platnosc_FK;
...
comment on column DyzurPracyPracownika.OD is 
'Dyzur od';

comment on column DyzurPracyPracownika."DO" is 
'Dyzur do';

/*==============================================================*/
/* Index: Association_4_PK                                      */
/*==============================================================*/
create unique index Association_4_PK on DyzurPracyPracownika (
NrPokoju ASC,
IDOsoby ASC
);
...
(
   IDPlatnosci          integer                        not null,
   DoZaplaty            integer                        null,
   TypPlatnosci         char(1)                        null,
   constraint PK_PLATNOSC primary key (IDPlatnosci)
);

comment on table Platnosc is 
'Informacja o platnosci.';

comment on column Platnosc.IDPlatnosci is 
'Identyfikator platnosci.';

comment on column Platnosc.DoZaplaty is 
'Informacja o zaplacie w PLN.';

comment on column Platnosc.TypPlatnosci is 
'Typ platnosci: K - karta. G - gotowka. P - przelew.';

comment on primary key on Platnosc is 
'PI platnosci.';

/*==============================================================*/
/* Index: Platnosc_PK                                           */
/*==============================================================*/
create unique index Platnosc_PK on Platnosc (
IDPlatnosci ASC
);
...
comment on column Rezerwacja.IDPlatnosci is 
'Identyfikator platnosci.';
...
/*==============================================================*/
/* Index: Rezerwacja_Platnosc_FK                                */
/*==============================================================*/
create index Rezerwacja_Platnosc_FK on Rezerwacja (
IDPlatnosci ASC
);
...
alter table Rezerwacja
   add constraint FK_Rezerwacja_Platnosc foreign key (IDPlatnosci)
      references Platnosc (IDPlatnosci)
      on update restrict
      on delete cascade;

comment on foreign key Rezerwacja.FK_Rezerwacja_Platnosc is 
'Zaplata za rezerwacje. ';
